...
function formValidate() {
    ...
    if (!addresspattern.test(address))
        document.querySelector("#address").innerHTML = "Kindly fill Address field"
    else
        document.querySelector("#address").innerHTML = ""

    //email field
    if (!emailpattern.test(email))
        document.querySelector("#email").innerHTML = "Kindly fill Email field"
    else
    ...
    if (confirmpassword.length === 0)
        document.querySelector("#cpwd").innerHTML = "Kindly fill this field"
    else {
    ...
    if (!phonepattern.test(phone))
        document.querySelector("#phone").innerHTML = "Kindly fill this field"
    else
